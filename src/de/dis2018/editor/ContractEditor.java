...
public class ContractEditor {
	...
	public void showContracts() {
		...
		while (itmv.hasNext()) {
			...
			System.out.println("Tenancy contract " + mv.getContractNo() + "\n" + "\tSigned in " + mv.getPlace() + " on "
					+ Helper.dateToString(mv.getDate()) + "\n" + "\tTenant :  " + mv.getContractPartner().getFirstname()
					+ " " + mv.getContractPartner().getName() + "\n" + "\tApartment:" + mv.getApartment().getStreet()
					+ " " + mv.getApartment().getStreetnumber() + ", " + mv.getApartment().getPostalcode() + " "
					+ mv.getApartment().getCity() + "\n" + "\tPrice:    " + mv.getApartment().getRent()
					+ " Euro, additional costs : " + mv.getAdditionalCosts() + " Euro\n" + "\tStart date: "
					+ Helper.dateToString(mv.getStartDate()) + ", duration: " + mv.getDuration() + " months\n");
		...
		while (itkv.hasNext()) {
			...
			System.out.println("Purchase contract " + kv.getContractNo() + "\n" + "\tSigned in " + kv.getPlace()
					+ " on " + Helper.dateToString(kv.getDate()) + "\n" + "\tBuyer:    "
					+ kv.getContractPartner().getFirstname() + " " + kv.getContractPartner().getName() + "\n"
					+ "\tHouse:    " + kv.getHouse().getStreet() + " " + kv.getHouse().getStreetnumber() + ", "
					+ kv.getHouse().getPostalcode() + " " + kv.getHouse().getCity() + "\n" + "\tPrice:    "
					+ kv.getHouse().getPrice() + " Euro\n" + "\tNo of Installments: " + kv.getNoOfInstallments()
					+ ", Inrest rate: " + kv.getIntrestRate() + "%\n");
		}
	}
